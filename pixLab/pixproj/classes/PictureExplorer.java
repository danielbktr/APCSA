/*
 * Purpose: This program allows us to work with an application of 2d arrays,
 * images, in a convenient and easy to visualize format. 
 * We can also explore how scaling and using different images affects the array and image itself.
 * 
 * < Daniel Boktor>
 * < April 21, 2023>
*/
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  public static void main( String args[])
  {
    ...
    Picture smallPic = pix.scale(0.5,0.5);
    smallPic.write("smallMyPicture.jpg");
    smallPic.explore();
  }  
