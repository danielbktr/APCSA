...
public class DeckTester
{
   ...
   public static void main(String[] args)
   {
      ...
      String[] myRanks = {"ace","two","four","five","six","nine","ten","three","eight","seven"};
      String[] mySuits = {"hearts","spades","spades","diamonds","hearts","spades","diamonds","hearts","hearts","spades"};
      int[] myPointValues = {1,2,4,5,6,9,10,3,8,7};
      ...
      System.out.println("  toString: " +myDeck);
      System.out.println("  isEmpty: "+ myDeck.isEmpty() );
      System.out.println("  size: "  +myDeck.size());
      System.out.println();
      System.out.println();
