...
public class Magpie2v2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if ((findKeyword(statement, "Bromley") >= 0)||(findKeyword(statement, "Jessica Bromley") >= 0)){
            response = ("She sounds like a good teacher!");
        }
        else if (findKeyword(statement, "felt") >= 0){
            response = ("Interesting");
        }
        else if (findKeyword(statement, "weird")>= 0){
            response = ("That's not a nice thing to say.");
        }
        ...
        else if (findKeyword(statement,"cowboy")>= 0 ){
            response = ("Wow, that's very cool!");
        }
        else if (findKeyword(statement, "Alan Turing") >=0){
            response = ("He was foundational in developing our modern computing systems");
        }
